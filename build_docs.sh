...
git clone https://github.com/ros/console_bridge/ src/ros/console_bridge
colcon build --packages-up-to class_loader console_bridge geometry2 rclcpp_action rclcpp_components rclcpp_lifecycle rclpy ament_index_cpp ament_index_python libstatistics_collector
